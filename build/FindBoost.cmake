...
macro(_Boost_FIND_LIBRARY var build_type)
  ...
  if(Boost_LIBRARY_DIR_${build_type})
    ...
    _Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}"
...
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "_boost_TEST_VERSIONS")
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_USE_MULTITHREADED")
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_USE_STATIC_LIBS")
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_USE_STATIC_RUNTIME")
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_ADDITIONAL_VERSIONS")
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_NO_SYSTEM_PATHS")
...
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "BOOST_ROOT")
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "BOOST_ROOT" ENVIRONMENT)
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "BOOST_INCLUDEDIR")
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "BOOST_INCLUDEDIR" ENVIRONMENT)
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "BOOST_LIBRARYDIR")
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "BOOST_LIBRARYDIR" ENVIRONMENT)
...
if(NOT Boost_INCLUDE_DIR)
  ...
  _Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "_boost_INCLUDE_SEARCH_DIRS")
  _Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "_boost_PATH_SUFFIXES")
...
if(Boost_INCLUDE_DIR)
  _Boost_DEBUG_PRINT("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}"
  ...
  _Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_VERSION")
  _Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_VERSION_STRING")
  _Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_VERSION_MACRO")
  _Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_VERSION_MAJOR")
  _Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_VERSION_MINOR")
  _Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_VERSION_PATCH")
  _Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_VERSION_COUNT")
endif()
...
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_LIB_PREFIX")
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "Boost_NAMESPACE")
...
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "_boost_MULTITHREADED")
...
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "_boost_RELEASE_ABI_TAG")
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "_boost_DEBUG_ABI_TAG")
...
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "_boost_LIBRARY_SEARCH_DIRS_RELEASE")
_Boost_DEBUG_PRINT_VAR("FindBoost.cmake" "${CMAKE_CURRENT_LIST_LINE}" "_boost_LIBRARY_SEARCH_DIRS_DEBUG")
